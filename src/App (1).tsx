...
// ─── THEME CONTEXT ────────────────────────────────────────────────────────────
const ThemeCtx = createContext<null>(null);
...
function TrainTab({ profile, onOpenWorkout }: { profile: any, onOpenWorkout: (w: any) => void }) {
  return (
...
// ─── PROFILE + THEME TAB ─────────────────────────────────────────────────────
function ProfileTab({ profile, currentThemeId, onThemeChange }: { profile: any, currentThemeId: string, onThemeChange: (id: string) => void }) {
...
export default function App() {
  ...
  return (
    <div style={{
      ...
      {screen === "app" && !activeWorkout && !workoutDetail && (
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
            ...
            <span style={{ color: T.white, fontFamily: "'Cormorant Garamond', serif", fontWeight: 300, fontSize: 19, letterSpacing: 4, textTransform: "uppercase" }}>Soma</span>
            <span style={{ color: T.muted, fontFamily: "'Cormorant Garamond', serif", fontWeight: 300, fontSize: 11, letterSpacing: 1.5, textTransform: "uppercase", paddingBottom: 1 }}>: Your Intelligent Trainer</span>
          </div>
          ...
          <div style={{
            ...
            boxShadow: `0 4px 12px ${T.lime}44`
      ...
      {/* ── Page content ────────────────────────────────────────────────── */}
      <div style={{ flex: 1, display: "flex", flexDirection: "column", width: "100%", maxWidth: 960, margin: "0 auto", padding: "0 24px" }}>
